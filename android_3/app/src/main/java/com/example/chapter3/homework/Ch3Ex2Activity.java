...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        // X
        ObjectAnimator scaleXAnimator = ObjectAnimator.ofFloat(findViewById(R.id.target),"scaleX", (float) 1, (float) 2);
        scaleXAnimator.setRepeatCount(ObjectAnimator.INFINITE);
        scaleXAnimator.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        scaleXAnimator.setRepeatMode(ValueAnimator.REVERSE);
        // Y
        ObjectAnimator scaleYAnimator = ObjectAnimator.ofFloat(findViewById(R.id.target),"scaleY",(float) 1, (float) 2);
        ...
        ObjectAnimator alphaAnimator = ObjectAnimator.ofFloat(findViewById(R.id.target),"alpha", 1.0f, 0.5f);
